                ...
                <div class="col formulario">
                    <form method="POST" action="conexao.php">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nome"  value="<?php echo $_GET['nome']; ?>" id="nome" required>
                        </div>  

                        <div class="mb-3">
                            <label class="formulario_titulos" for="tele">Endereço:</label> 
                            <input type="text" class="form-control"  name="endereco" value="<?php echo $_GET['endereco']; ?>" id="endereco" required>
                        </div> 

                        <div class="mb-3">
                            <label for="select" class="form-label formulario_titulos">Bairro:</label>
                            <input type="text" class="form-control" name="bairro" value="<?php echo $_GET['bairro']; ?>" id="bairro" required>
                        </div>

                        <div class="mb-3">
                            <label class="formulario_titulos" for="data">CEP:</label> 
                            <input type="tel" class="form-control" placeholder="xxxxx-xxx" id="cep" value="<?php echo $_GET['cep']; ?>" name="cep" required>
                        </div>

                        <div class="mb-3">
                            <label for="select" class="form-label formulario_titulos">Cidade:</label>
                            <input type="text" class="form-control" name="cidade" value="<?php echo $_GET['cidade']; ?>" id="cidade" required>
                        </div>
